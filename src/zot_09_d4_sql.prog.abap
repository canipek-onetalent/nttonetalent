...
*DATA gs_main TYPE zot_09_t_main.
...
*  DATA lr_id TYPE RANGE OF zot_09_t_main-id.
...
*  DELETE FROM zot_09_t_main WHERE id = 020
...
*  UPDATE zot_09_t_main SET name = 'Ahmet'
*  WHERE id = 003
...
*  DATA lt_main_modify TYPE TABLE OF zot_09_t_main.
*
*  APPEND VALUE #( id        = 09
*                  save_date = sy-datum
*                  name      = 'Tarık'
...
*
*  MODIFY zot_09_t_main FROM TABLE lt_main_modify.
*  IF sy-subrc = 0.
*    COMMIT WORK AND WAIT.
*    WRITE :/ 'Success'.
*  ELSE.
